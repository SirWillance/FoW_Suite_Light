...
app.registerExtension({
    name: "FoW_Suite_LIGHT.PromptFusionNegative",
    async beforeRegisterNodeDef(nodeType, nodeData, app) {
        if (nodeData.name === "FoWLPromptFusionNegative") {
            const MAX_INPUT_COUNT = 4;  
            const NAMED_INPUTS = ["Static", "Content", "Definition", "Dynamic"];  
    ...
    VERSION: "Standart",  // Updated version
});